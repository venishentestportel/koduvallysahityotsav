...
fs.writeFileSync('design-studio2.html', admin);
console.log('Successfully copied and updated design-studio2.html (with proper state initialization for bulk upload)');
